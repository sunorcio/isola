...
struct ISOLA_window{
	...
	float pixelScale; /* single pixel scale, inverse of lower bound resolution */
...
#define ISOLA_STATE_CULLFACE 0x00000004
#define ISOLA_STATE_DEPTHTEST 0x00000008
#define ISOLA_STATE_DITHER 0x00000010
#define ISOLA_STATE_SCISSORTEST 0x00000020
#define ISOLA_STATE_STENCILTEST 0x00000040
#define ISOLA_STATE_SRGBFRAMEBUFFER 0x00000080
/* #define ISOLA_STATE_POINTSMOOTH 0x00000100 */
#define ISOLA_STATE_LINESMOOTH 0x00000200
#define ISOLA_STATE_POLYGONSMOOTH 0x00000400
#define ISOLA_STATE_POINTSIZEPROGRAM 0x00000800
#define ISOLA_STATE_MULTISAMPLE 0x00001000
